...
The new solution will be celebrated every November on the 3rd Wednesday of the month. In 2016 the 3rd Wednesday falls on the 16th of November.
...
function solution(x, weekDay, month, yearNumber) {
    let weekDayNum = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"].indexOf(weekDay);
    let monthNum = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"].indexOf(month);
    let date = new Date(yearNumber, monthNum, 7*x-6);
